...
(function() {
    ...
    function setStyles() {
        head.append("<style>.js-issue.ghx-issue-compact.ghx-done {background-color:" + colors.done+ "} .js-issue.ghx-issue-compact.ghx-issue-my {background-color: " + colors.my + "}</style>");    
    }
